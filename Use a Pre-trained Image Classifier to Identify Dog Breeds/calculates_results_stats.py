...
#                                                                             
# PROGRAMMER: Erfan Hosseinian Rad
...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic['pct_correct_dogs'] = 0.0 #1a
    results_stats_dic['pct_correct_notdogs'] = 0.0 #1b
    results_stats_dic['pct_correct_breed'] = 0.0 #2
